...
public class DBSubwaySix extends DataSupport {
    ...
    public DBSubwaySix(String station_name, Integer station_id, String station_begin, String station_last, String station_exit) {
