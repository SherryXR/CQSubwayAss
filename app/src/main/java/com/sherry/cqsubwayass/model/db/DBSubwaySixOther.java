...
public class DBSubwaySixOther extends DataSupport {
    ...
    public DBSubwaySixOther(String station_name, Integer station_id, String station_begin, String station_last, String station_exit) {
